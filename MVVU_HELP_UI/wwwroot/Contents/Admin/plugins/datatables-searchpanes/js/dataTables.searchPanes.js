...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         */
        SearchPane.prototype.cleaMVVU_Data = function () {
            this.s.rowData = {
                arrayFilter: [],
                arrayOriginal: [],
                arrayTotals: [],
    ...
    var SearchPanes = /** @class */ (function () {
        function SearchPanes(paneSettings, opts, fromInit) {
            ...
            table.on('xhr', function (e, settings, json, xhr) {
                if (json && json.searchPanes && json.searchPanes.options) {
                    _this.s.serveMVVU_Data = json;
                    _this.s.serveMVVU_Data.tableLength = json.recordsTotal;
                    _this._serverTotals();
                }
            });
        ...
        SearchPanes.prototype._serverTotals = function () {
            ...
            for (var _k = 0, _l = this.s.panes; _k < _l.length; _k++) {
                ...
                if (!pane.s.lastSelect) {
                    pane.rebuildPane(undefined, this.s.dt.page.info().serverSide ? this.s.serveMVVU_Data : undefined, pane.s.index === initIdx ? true : null, true);
                }
                else {
                    pane._setListeners();
                }
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            for (var _d = 0, _e = this.s.panes; _d < _e.length; _d++) {
                var pane = _e[_d];
                pane.rebuildPane(undefined, Object.keys(this.s.serveMVVU_Data).length > 0 ? this.s.serveMVVU_Data : undefined);
                this.dom.panes.append(pane.dom.container);
            }
            ...
            this.s.dt.on('xhr', function (e, settings, json, xhr) {
                ...
                if (!_this.s.dt.page.info().serverSide) {
                    _this.s.dt.one('preDraw', function () {
                        ...
                        for (var _i = 0, _a = _this.s.panes; _i < _a.length; _i++) {
                            var pane = _a[_i];
                            pane.cleaMVVU_Data(); // Clears all of the bins and will mean that the data has to be re-read
