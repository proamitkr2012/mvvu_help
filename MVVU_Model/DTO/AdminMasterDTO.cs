...
namespace MVVU_Model.DTO
{
    public class AdminMasterDTO
    {
        ...
        public string[] CtypeListChoose { get; set; }
        ...
        public List<Role> RolesDataList { get; set; }
        public List<Role> RolesSelectedList { get; set; }
        public List<TblHelpDeskComplaintType_AM> CtySelectedList { get; set; }
        public IEnumerable<SelectListItem> RoleMaster { get; set; }
        public IEnumerable<SelectListItem> CtMaster { get; set; }
        public List<TblHelpDeskComplaintType_AM> CtypeList { get; set; }
    }
}
